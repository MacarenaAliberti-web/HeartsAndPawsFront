          ...
          >
            {showPassword ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-5 0-9-4-9-9a8.966 8.966 0 012.292-5.708m.618 6.076a4.48 4.48 0 006.444 6.444m1.568-1.568A9.968 9.968 0 0121 10c0-1.61-.406-3.137-1.125-4.475M3 3l18 18" />
              </svg>
            ) : (
              // ojo abierto
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
